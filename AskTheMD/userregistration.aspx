<%@ Page Title="" Language="C#" MasterPageFile="~/Layout2.master" AutoEventWireup="true" CodeFile="userregistration.aspx.cs" Inherits="_Default" %>
			...
			<div class="row main">
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h1 class="title" style="margin-top:-100px;">User Signup</h1>
	               		<hr />
	               	</div>
	            </div> 
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" class="form-control" TextMode="Password" placeholder="Password"></asp:TextBox>                               
                      ...
                      <div class="form-group">
							<div class="cols-lg-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                    <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="RePassword"></asp:TextBox>                              
								</div>
                      ...
                      <!--Dept-->
                       <div class="form-group">
							<div class="cols-lg-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                    <asp:TextBox ID="dept" runat="server" class="form-control" placeholder="Department" ></asp:TextBox>
								</div>
                                 <asp:Label ID="Label2" runat="server" Text="."></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                    ControlToValidate="dept" ErrorMessage="Depatment can not be Blank" 
                                    Font-Bold="True" ForeColor="Red">*</asp:RequiredFieldValidator>
							</div>
						</div>
